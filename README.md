...
## Technology Used
*The project was developed using p5js in conjunction with an LLM. Simply download and unzip the files, then run the complete file in VS Code to get started. Furthermore, you can update the project by inserting a new .txt file into the directory.*
